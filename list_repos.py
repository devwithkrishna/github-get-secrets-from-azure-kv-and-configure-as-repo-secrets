...
def list_repos(search_string: str):
	...
	while True:
		...
		for repo in response_json:
			list_of_repo_names.append(repo['name'])
	...
	matching_repos = [repo for repo in list_of_repo_names if repo.startswith(f'{search_string}')]
	len_of_matching_repos = len(matching_repos)
	print(f'Found {len_of_matching_repos} repos matching the search string "{search_string}"')
